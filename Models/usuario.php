...
class login_model
{
	...
	function editardatos($nombre,$tipo,$identificacion,$nom_ape,$id_user){

	$sql="UPDATE  usuarios   set usuario='$nombre' , nombre_user='$nom_ape' , identificacion='$identificacion' , tipo='$tipo' where  id_user='$id_user' ";
	...
	function usuarios($user,$pass){
		...
		if ($buscar=='') 
		{
		  ...
		  function ingresarUsuario($id,$usuario,$clave,$nombreApellido,$identificacion,$tipo)
		  {
			$sql="INSERT  INTO usuarios VALUES('$id','$usuario','$clave','$nombreApellido','$identificacion','$tipo')";
...
/*
	$ins= new login_model();
	$array=$ins->usuarios('admin','admin');
