...
<br><br><br>
  ...
  <ul class="nav nav-tabs ">
      ...
      <li role="presentation"><a href="lista2_Anulados.php">Lista  Anulados</a></li>
      <li role="presentation"><a href="lista2Pagados.php">Lista  Pagados</a></li>
  </ul>
...
<div class="col-xs-3">
          ...
          <div class="btn-group">
            ...
            <ul role="menu" class="dropdown-menu">
              <li><a href="#" type="button" class="btn btn-primary" data-toggle="modal" data-target="#formIng">Ingresar Infractor</a></li>
      ...
      <div class="row col-md-4">
        ...
        <div class="navbar   navbar-inverse">
           ...
           <form  class='form-inline'  method='POST' id='form_filtro' action='principal.php'>
              <div id="filtroemp">
              </div>
            ...
            function listaemp(){
              ...
              $.ajax({
                ...
                success:function(resp){
                  ...
                  html="<select name='empresa'  class='inputs prueba' required>";
...
$('#emp').val($(this).parent().parent().children('td:eq(3)').text());//EMPRESA
