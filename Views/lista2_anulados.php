...
<html>
  ...
  <script src="//code.jquery.com/ui/1.11.4/jquery-ui.js"></script>
    ...
    <link rel="stylesheet" href="../Resources/css/estilo.css">    <title>Conductores  Anulados</title>
...
"><?php echo $_SESSION['nombre']; ?></a>
    ...
    <ul class="nav nav-tabs">
      ...
      <li role="presentation" ><a href="principal.php">Home</a></li>
      <li role="presentation" class="active"><a href="lista2_anulados.php">Lista  Anulados</a></li>
